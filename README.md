...
- **Documentation Generation:** The program leverages WIDOCO, a widely adopted tool for generating comprehensive documentation from ontology files. WIDOCO is integrated into the GitHub Actions workflow, ensuring that documentation is automatically generated and updated with each commit, promoting transparency and accessibility of ontological resources.
